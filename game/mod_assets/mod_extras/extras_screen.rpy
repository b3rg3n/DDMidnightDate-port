            ...
            vpgrid id "ext":
                ...
                frame:
                    ...
                    vbox:
                        ...
                        yalign 0.5
                        imagebutton:
                            idle LiveComposite((150, 130), (0, -10), "mod_assets/mod_extra_images/gallery.png", (40, 75), Text("Галерея", style="extras_text"))
                            hover LiveComposite((150, 130), (0, -10), "mod_assets/mod_extra_images/gallery.png", (38, 73), Text("Галерея", style="extras_hover_text"))
                ...
                frame:
                    ...
                    vbox:
                        ...
                        yalign 0.5
                        imagebutton:
                            idle LiveComposite((150, 130), (0, -10), "mod_assets/mod_extra_images/achievements.png", (40, 75), Text("Награды", style="extras_text"))
                            hover LiveComposite((150, 130), (0, -10), "mod_assets/mod_extra_images/achievements.png", (38, 73), Text("Награды", style="extras_hover_text"))
