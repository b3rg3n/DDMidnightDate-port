...
init python:
    ...
    startup = Achievements("Добро пожаловать в мир DDLC!", "Спасибо, что согласились с условиями пользования.",
...
screen achievements():
    ...
    use game_menu(_("Награды")):
        ...
        textbutton "?":
            style "return_button"
            xpos 0.99 ypos 1.1
            action ShowMenu("dialog", "{b}Помощь{/b}\nСерые иконки означают то, что эти достижения закрыты.\nПродолжайте ваш прогресс в [config.name],\nчтобы открыть все возможные достижения.", ok_action=Hide("dialog"))
...
screen achievement_notify(reward):
    ...
    frame at achievement_notif_transition:
        ...
        hbox:
            ...
            vbox:
                spacing 5
                text "Достижение получено!" size 16
