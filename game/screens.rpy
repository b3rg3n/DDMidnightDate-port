...
init -1 style edited is default:
    font "mod_assets/LiberationSefif-Regular.ttf"
    kerning 8
    outlines [(10, "#000", 0, 0)]
    xpos gui.text_xpos
...
init -501 screen navigation():
    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            textbutton _("Дополнительно") action [ShowMenu("extras"), SensitiveIf(renpy.get_screen("extras") == None)]
            ...
            if renpy.variant("pc"):
                ...
                textbutton _("Помощь") action [Help("README.html"), Show(screen="dialog", message="Файл открыт в вашем браузере.", ok_action=Hide("dialog"))]
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("Скорость авто-промотки")
...
init -501 screen name_input(message, ok_action):
    ...
    frame:
        ...
        input default "" value VariableInputValue("player") length 12 allow "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyzАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯёйцукенгшщзхъфывапролджэячсмитьбю"
